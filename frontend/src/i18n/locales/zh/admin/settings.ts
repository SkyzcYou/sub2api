export default {
    settings: {
      ...
      site: {
        ...
        faviconHint: 'PNG、JPG、GIF、SVG 或 ICO 格式，最大 300KB。建议：32x32px 正方形图片。',
      ...
      customMenu: {
        ...
        visibilityAdmin: '管理员',
        authMode: '身份信息传递',
        authModeNone: '不传递身份信息（推荐）',
        authModeQuery: '通过 URL 传递用户 ID 和登录令牌',
        authModeHint: '只有完全受你控制的系统才应接收身份信息；第三方页面请保持“不传递”。',
        add: '添加菜单项',
        remove: '删除',
        moveUp: '上移',
        moveDown: '下移',
